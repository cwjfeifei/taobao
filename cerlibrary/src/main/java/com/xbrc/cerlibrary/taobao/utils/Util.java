...
/*
import com.yd.data.cmcc.CAH;
import com.yd.data.cmcc.CBJ;
import com.yd.data.cmcc.CCQ;
import com.yd.data.cmcc.CFJ;
import com.yd.data.cmcc.CGD;
import com.yd.data.cmcc.CGS;
import com.yd.data.cmcc.CGX;
import com.yd.data.cmcc.CGZ;
import com.yd.data.cmcc.CHA;
import com.yd.data.cmcc.CHB;
import com.yd.data.cmcc.CHE;
import com.yd.data.cmcc.CHI;
import com.yd.data.cmcc.CHL;
import com.yd.data.cmcc.CHN;
import com.yd.data.cmcc.CJL;
import com.yd.data.cmcc.CJS;
import com.yd.data.cmcc.CJX;
import com.yd.data.cmcc.CLN;
import com.yd.data.cmcc.CMCCShop;
import com.yd.data.cmcc.CNM;
import com.yd.data.cmcc.CNX;
import com.yd.data.cmcc.CQH;
import com.yd.data.cmcc.CSC;
import com.yd.data.cmcc.CSD;
import com.yd.data.cmcc.CSH;
import com.yd.data.cmcc.CSN;
import com.yd.data.cmcc.CSX;
import com.yd.data.cmcc.CTJ;
import com.yd.data.cmcc.CXJ;
import com.yd.data.cmcc.CXZ;
import com.yd.data.cmcc.CYN;
import com.yd.data.cmcc.CZJ;*/
...
public class Util
{
	...
	public static String replRand(String url)
	{
		return url.replace("{r}", Double.toString(Math.random())).replace("{t}", Long.toString(System.currentTimeMillis()));
	}

	public static String replace(String url, Map<String, String> map)
	{
	 ...
	 * @return 指定日期所在月的最后一天
	 */
	public static Calendar getLastDay(Calendar c)
	{
		c.add(Calendar.MONTH, 1);
		c.set(Calendar.DAY_OF_MONTH, 1);
		c.add(Calendar.DAY_OF_MONTH, -1);
	 ...
	 * @return 指定日期所在月的第一天
	 */
	public static Calendar getFirstDay(Calendar c)
	{
		c.set(Calendar.DAY_OF_MONTH, 1);
		return c;
	}

	public static List<NameValuePair> toPair(Map<String, String> map)
	{
